...
Você deve implementar o método checkPV, que recebe uma BST com nodes vermelhos ou pretos. Para isso você vai precisar verificar se ao fim das adições, a árvore resultante é PV.
